...
import { ConfirmEmail, UpdateUser, LoadSelf } from '../../actions/user.actions';
import { Actions, ofType } from '@ngrx/effects';
import { Success, CoreActionTypes, Failure } from 'src/app/core/actions/core.actions';
