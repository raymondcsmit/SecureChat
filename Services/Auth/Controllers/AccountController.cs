    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = await _loginService.SignInByUserNameAsync(model.Username, model.Password, props);
                if (user != null)
                {
                    _logger.LogInformation($"Login success. User: {model.Username}");
                ...
                _logger.LogWarning($"Login failure. User: {model.Username}");
